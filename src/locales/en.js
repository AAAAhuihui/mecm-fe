...
const en = {
  ...
  app: {
    ...
    distriList: {
      ...
      cpuRequestPlaceholder: 'Enter CPU cores, e.g. 2',
      cpuRequestInvalid: 'CPU request must be a positive number',
      cpuRequestMaxExceeded: 'CPU request must not exceed 100',
      memoryRequest: 'Memory Request',
      memoryRequestPlaceholder: 'Enter memory in Mi, e.g. 2048',
      memoryRequestInvalid: 'Memory request must be a positive integer',
      memoryRequestMaxExceeded: 'Memory request must not exceed 128 Gi (131072 Mi)',
      resourceRequestPairRequired: 'CPU and memory requests must be filled together',
      mountType: 'Storage mount',
      selectMountType: 'Select mount type',
      mountTypeNone: 'None',
      mountTypeHostPath: 'HostPath',
      hostPathField: 'Host path',
      hostPathPlaceholder: 'e.g. /home/mec/mountpath',
      containerMountPath: 'Container mount path',
      containerMountPathPlaceholder: 'e.g. /usr/app/mountpath',
      hostPathMountBothRequired: 'Host path and container path are required for HostPath',
      hostPathMountAbsolute: 'Paths must start with /'
    },
    instanceList: {
      ...
      rulesExistBeforeDelete: 'DNS/traffic rules are still configured. Please remove them in Rule Configuration before deleting the instance.',
      signalingRulesExistBeforeDelete: 'Signaling (policy) records still exist for this app. Please cancel or delete them in Signaling Manager before deleting the instance.',
      batchRulesExistBeforeDelete: 'Some selected instances still have DNS/traffic rules. Please clean them up in Rule Configuration first.',
      batchSignalingRulesExistBeforeDelete: 'Some selected instances still have signaling policy records. Please clean them up in Signaling Manager first.',
      goToRuleConfig: 'Go to Rule Configuration',
      goToSignaling: 'Go to Signaling Manager',
      checkRulesFailed: 'Failed to verify rules or signaling status. Please try again later.',
      addRule: 'Add Rules',
