...
const cn = {
  ...
  app: {
    ...
    distriList: {
      ...
      cpuRequest: 'CPU资源请求',
      cpuRequestPlaceholder: '请输入CPU个数，如2',
      cpuRequestInvalid: 'CPU资源请求必须为正数',
      cpuRequestMaxExceeded: 'CPU资源请求不能超过100',
      memoryRequest: '内存资源请求',
      memoryRequestPlaceholder: '请输入内存大小，如2048',
      memoryRequestInvalid: '内存资源请求必须为正整数',
      memoryRequestMaxExceeded: '内存资源请求不能超过128Gi（131072 Mi）',
      resourceRequestPairRequired: 'CPU和内存资源请求需同时填写',
      mountType: '存储挂载方式',
      selectMountType: '请选择挂载方式',
      mountTypeNone: '不挂载',
      mountTypeHostPath: 'HostPath',
      hostPathField: '节点路径',
      hostPathPlaceholder: '例如 /home/mec/mountpath',
      containerMountPath: '容器路径',
      containerMountPathPlaceholder: '例如 /usr/app/mountpath',
      hostPathMountBothRequired: '选择 HostPath 时需填写节点路径与容器路径',
      hostPathMountAbsolute: '路径须以 / 开头'
    },
    instanceList: {
      ...
      rulesExistBeforeDelete: '该应用仍存在 DNS/流量等规则配置，请先在「规则配置」中删除后再删除应用实例。',
      signalingRulesExistBeforeDelete: '该应用仍存在规则下发记录，请先在「规则下发」中撤销或删除对应记录后，再删除应用实例。',
      batchRulesExistBeforeDelete: '所选实例中仍有未清理的 DNS/流量规则配置，请先在「规则配置」中处理后再删除。',
      batchSignalingRulesExistBeforeDelete: '所选实例中仍有规则下发记录，请先在「规则下发」中处理后再删除。',
      goToRuleConfig: '去规则配置',
      goToSignaling: '去规则下发',
      checkRulesFailed: '校验规则或规则下发状态失败，请稍后重试。',
      addRule: '添加规则',
